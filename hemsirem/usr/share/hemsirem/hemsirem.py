...
class HemşiremApp(QMainWindow):
    ...
    def setup_ui(self):
        ...
        self.sub_title_label = QLabel("İlaç ve Randevu Hatırlatıcısı")
    ...
    def show_about_dialog(self):
        QMessageBox.about(self, "Hakkında", "Hemşirem İlaç ve Randevu Hatırlatıcısı\n"
                                          ...
                                          "Bu program ilaç ve randevu hatırlatmak amacıyla geliştirilmiştir. \nBu program hiçbir garanti getirmez.")
    ...
    def setup_tray_icon(self):
        ...
        self.tray_icon.setToolTip("Hemşirem İlaç ve Randevu Hatırlatıcısı") # Fare üzerine gelince görünen metin
